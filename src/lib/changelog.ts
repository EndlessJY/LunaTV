...
export const changelog: ChangelogEntry[] = [
  {
    ...
    added: [
    "新增全局错误边界组件，提升应用稳定性",
    "新增自动错误处理脚本，智能重试失败的资源加载",
    "新增 Chunk 加载失败自动恢复机制"
    ],
    changed: [
    "优化 Next.js 配置：启用 SWC 压缩和 React 严格模式",
    "优化字体加载配置：添加 font-display: swap 和预加载",
    "优化静态资源缓存策略，提升加载性能",
    "升级 Node.js 项目版本到 0.2.0"
    ],
    fixed: [
    "修复 ChunkLoadError 导致的页面加载失败问题",
    "修复 React #423 错误和相关 hydration 问题",
    "修复 CSS 文件加载失败导致的样式丢失",
    "修复字体预加载警告和资源浪费问题",
    "修复构建时的静态渲染错误",
    "改善错误提示用户体验，提供友好的错误信息"
    ]
  },
  {
    version: "103.0.0",
